const tests = [
  ...
  './test-p5-hsk2-4.mjs','./test-p5-runtime.mjs','./test-p6-hsk5-7.mjs','./test-p6-runtime.mjs','./test-p7-examples-reading.mjs','./test-p7-runtime.mjs','./test-p8-reading-hsk6-7.mjs','./test-p8-runtime.mjs','./test-p9-more-hsk7-reading.mjs'
];
for (const test of tests) await import(test);
console.log('\n✓ Toàn bộ kiểm thử P0–P9 đã đạt.');
